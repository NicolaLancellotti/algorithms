...
final class SinglyLinkedListTests: XCTestCase {
  ...
  func test_collection() {
    ...
    XCTAssertEqual(list.firstIndex(of: 2), list.index(after: list.startIndex))
  }
  ...
  func test_hashable() {
    let list = SinglyLinkedList<Int>([1, 2, 3])
    XCTAssertEqual(list.hashValue, list.hashValue)
  }
  ...
  static var allTests = [
    ...
    ("test_otherMethods", test_otherMethods),
    ("test_rangeReplaceableCollection_init", test_rangeReplaceableCollection_init),
    ("test_rangeReplaceableCollection_append", test_rangeReplaceableCollection_append),
    ("test_rangeReplaceableCollection_remove", test_rangeReplaceableCollection_remove),
